...
export function PageHeader({ eyebrow, title, subtitle, actions }) {
  return (
    <div className="border-b border-slate-200 bg-white px-4 sm:px-8 py-4 sm:py-6 flex flex-wrap items-end justify-between gap-4">
      <div>
...
export function PageBody({ children }) {
  return <div className="p-4 sm:p-8 space-y-6">{children}</div>;
}
